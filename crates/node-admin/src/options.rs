...
use crate::service::NodeAdminService;

/// # Node admin server options
#[serde_as]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, derive_builder::Builder)]
#[cfg_attr(feature = "options_schema", derive(schemars::JsonSchema))]
#[cfg_attr(
    feature = "options_schema",
    schemars(rename = "NodeAdminServiceOptions")
)]
#[cfg_attr(feature = "options_schema", schemars(default))]
pub struct Options {
    /// Address to bind for the Node Admin Service.
...
impl Options {
    pub fn build(self) -> NodeAdminService {
        NodeAdminService::new(self)
    }
}
